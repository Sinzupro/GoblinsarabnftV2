      ...
      <>
        ...
        {this.isWalletConnected() ? (
          ...
          <div className="no-wallet">
            <div className="welcome  text-center font-sans text-2xl ">
              <div className="text-2xl ">
                ₐₐₐₐₐₐₐᵤᵤᵤᵤᵤGGGₕₕₕₕₕ ₙₒₑₑₙₛₜₐgᵣᵤₘ{' '}
                <span className="twitter text-1x1 ">
                  {' '}
                  <a href="https://twitter.com/GoblinsArabs" target="_blank">
                    🕊️
                  </a>
                </span>
              </div>
              <div className="write font-mono text-2xl ">
                5500 ງ໐๖liຖŞ คrē ຖ໐ຟ iຖ thē คrค๖ pēຖiŞนlค, frēē๓iຖt ຟith
                นtilitฯ, Ʉ₲ⱠɎ ₣Ø₦₮Ɇ₦Đ 😪
              </div>
            </div>
            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ? (
              <div className="merkle-proof-manual-address">
                ...
                <p>
                  Check if your on the Whitelist{' '}
                  <strong> only the owner of that address</strong>
                </p>
            ...
            <div className="use-block-explorer bg-gray-800  text-center pb-6">
              {!this.isWalletConnected() ? (
                <button
          ...
          <div className="merkle-proof-manual-address">
            <h2>Whitelist Proof</h2>
            <p>
              Check if your on the Whitelist <strong> only the owner of that address</strong> 
            </p>
